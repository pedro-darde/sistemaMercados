...
public class UsuarioDao {
 ...
 /** Método para criação de fornecedor no DB
     * @param f*/
     public void create(Usuario u){
        ...
        try {
            stmt = (PreparedStatement) con.prepareStatement("INSERT INTO tabela_usuario (nome,endereco,user,senha,adm) VALUES(?,?,?,?,?)");
            stmt.setString(1,u.getNome());
            stmt.setString(2, u.getEndereco());
            stmt.setString(3, u.getUser());
            stmt.setString(4, u.getSenha());
            stmt.setBoolean(5, u.isIsAdmin());
 ...
 /** Método que retorna a lista de fornecedores contidos no DB
    ...
    public List<Usuario> read() {
        ...
        try {
            ...
            while(rs.next()){
                ...
                usuario.setCodigo(rs.getInt("idtabela_usuario"));
                usuario.setEndereco(rs.getString("endereco"));
                usuario.setNome(rs.getString("nome"));
                usuario.setUser(rs.getString("user"));
                usuario.setSenha(rs.getString("senha"));
                usuario.setIsAdmin(rs.getBoolean("adm"));
                a.add(usuario);
    ...
    public List<Usuario> readUser(String busca) {
        Connection con = ConectionFactory.getConnection();
        PreparedStatement stmt = null;
        ResultSet rs = null;
          List<Usuario> a = new ArrayList<>();
        try {
            stmt = con.prepareStatement("SELECT * FROM tabela_usuario WHERE user LIKE ?");
...
//    }
    ...
    public boolean ValidarUser(Usuario usu){
             ...
             ResultSet rs = null;
                 ...
                 try {
             stmt = con.prepareStatement("SELECT * FROM tabela_usuario WHERE user LIKE ? AND senha ?");
